...
/**
 * Task App — Single‑file React frontend
 *
 * Drop this component into a Vite React (TS) project and render <TasksApp />.
 *
 ...
 *
 * Task shape expected from backend (you can adjust the interface below):
 *   {
 *     id: number | string,
 *     title: string,
 *     description?: string,
...
// ---- Config ----
const API_BASE = "http://0.0.0.0"; // e.g. "http://localhost:8000"
const tasksUrl = (path = "") => `${API_BASE}/api/tasks${path}`;
...
const selectStyle: React.CSSProperties = { ...inputBase, appearance: "none" };
